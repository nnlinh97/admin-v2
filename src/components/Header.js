                                ...
                                <ul className="nav navbar-nav">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <h4>
                                                                Support Team
                                                                <small>
                                                                    <i className="fa fa-clock-o" /> 5 mins</small>
                                                            </h4>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <h4>
                                                                ...
                                                                <small>
                                                                    <i className="fa fa-clock-o" /> 2 hours</small>
                                                            </h4>
                                                            <p>Why not buy a new awesome theme?</p>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <h4>
                                                                Developers
                                                        <small>
                                                                    <i className="fa fa-clock-o" /> Today</small>
                                                            </h4>
                                                            <p>Why not buy a new awesome theme?</p>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <h4>
                                                                Sales Department
                                                                    <small>
                                                                    <i className="fa fa-clock-o" /> Yesterday</small>
                                                            </h4>
                                                            <p>Why not buy a new awesome theme?</p>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <h4>
                                                                Reviewers
                                                                <small>
                                                                    <i className="fa fa-clock-o" /> 2 days</small>
                                                            </h4>
                                                            <p>Why not buy a new awesome theme?</p>
                                                        </a>
                                                    </li>
                                    ...
                                    <li className="dropdown user user-menu">
                                        <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <span className="hidden-xs">nnlinh97</span>
                                        </a>
                                        <ul className="dropdown-menu">
