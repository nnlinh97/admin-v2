...
class Route extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({
            arriveTime: this.props.data.route !== '' ? this.props.data.route.arrive_time : '',
            leaveTime: this.props.data.route !== '' ? this.props.data.route.leave_time : '',
            day: this.props.data.route !== '' ? this.props.data.route.day : '',
            detail: this.props.data.route !== '' ? this.props.data.route.detail : '',
            selected: this.props.data.route !== '' ? { label: this.props.data.route.location.name, id: this.props.data.route.location.id } : '',
        })
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.setState({
            arriveTime: nextProps.data.route !== '' ? nextProps.data.route.arrive_time : '',
            leaveTime: nextProps.data.route !== '' ? nextProps.data.route.leave_time : '',
            day: nextProps.data.route !== '' ? nextProps.data.route.day : '',
            detail: nextProps.data.route !== '' ? nextProps.data.route.detail : '',
            selected: nextProps.data.route !== '' ? { label: nextProps.data.route.location.name, id: nextProps.data.route.location.id } : '',
